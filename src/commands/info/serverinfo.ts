...
class ServerInfo extends Command {
  ...
  public aliases = ["server", "guild", "guildinfo"];
  public desc = "Kiírja a szerverről való információkat.";
  ...
  public async run(message: Message) {
    ...
    const verificationLevel = {
      ...
      VERY_HIGH:
        "Ellenőrzött e-mail, 5 percnél tovább van be regisztálva a Discordra, 10 perce tagja a szervernek, Telefonos duplalépcsős belépés",
    };
